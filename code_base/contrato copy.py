...
def contrato_view(page: ft.Page):
    ...
    def guardar_usuario(e):
        ...
        campos_obligatorios = [
            rut_final, contrato[0].value, contrato[1].value, contrato[2].value, contrato[3].value,
        ...
        mensaje.value = "✅ Contrato ingresados correctamente"
        mensaje.color = "green"
    ...
    def borrar_usuario(e):
        ...
        mensaje.value = "✅ Contrato eliminados correctamente"
        mensaje.color = "green"
